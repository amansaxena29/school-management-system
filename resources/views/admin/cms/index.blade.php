    ...
    <div style="background:#fff; border-radius:12px; padding:24px;
        ...
        <form method="POST" action="{{ route('cms.gallery.store') }}"
            ...
            <div style="display:flex; gap:10px; flex-wrap:wrap; align-items:flex-end;">
                <div style="flex:1; min-width:150px;">
                    <label style="font-size:0.8rem; color:#475569; font-weight:600;">
                        Upload Image File
                    </label>
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(160px,1fr)); gap:14px;">
            ...
            <div style="position:relative; background:#f1f5f9; border-radius:10px; overflow:hidden;">
                ...
                @if($img->caption)
                    <p style="font-size:0.75rem; color:#475569; padding:6px 8px; margin:0;">
                        {{ $img->caption }}
                    </p>
                @endif
                <form method="POST" action="{{ route('cms.gallery.delete', $img) }}"
                    ...
                    <button type="submit"
                            style="width:100%; background:#ef4444; color:#fff; border:none;
                                   border-radius:6px; padding:5px; font-size:0.75rem;
                                   cursor:pointer;">
                        🗑 Delete
                    </button>
                </form>
